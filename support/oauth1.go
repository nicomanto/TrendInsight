...
func getOauth1Token() *oauth1.Token {
	return oauth1.NewToken(viper.GetString("access_token"), viper.GetString("access_token_secret"))
}

// getOauth1Config() return oauth1 config from api_key and api_key_secret
func getOauth1Config() *oauth1.Config {
	return oauth1.NewConfig(viper.GetString("api_key"), viper.GetString("api_key_secret"))
}
